...
function extractVideoId(url) {
    ...
    // si shortmatch existe, on return son id (index 1)
    if (shortMatch?.[1]){
        return shortMatch[1];
    }
    ...
    // si watchmatch existe, on return son id (index 1)
    if (watchMatch?.[1]){
        return watchMatch[1];
    }
    ...
    // si embedmatch existe, on return son id (index 1)
    if (embedMatch?.[1]){
        return embedMatch[1];
    }
    ...
    // si shortsmatch existe, on return son id (index 1)
    if (shortsMatch?.[1]){
    ...
    // si vmatch existe, on return son id (index 1)
    if (vMatch?.[1]){
        return vMatch[1];
    }
