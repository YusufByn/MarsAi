...
import { upload, uploadCoverOnly, uploadStillsOnly, validateUploadedFilesContent } from '../middlewares/upload.middleware.js';
...
router.post('/video', uploadLimiter, upload, validateUploadedFilesContent, verifyRecaptcha, validateCreateVideo, uploadVideo);
