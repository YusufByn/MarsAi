    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] glass-navbar">
      <div className="max-w-[1440px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 bg-white/5 px-6 py-2 rounded-full border border-white/5">
          <Link to="/" className="text-gray-400 hover:text-white transition-colors" title="Accueil">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
          </Link>

          <Link to="/jury" className="text-gray-400 hover:text-white transition-colors" title="Jury">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {isSelector && (
            <>
              ...
              {/* Player */}
              <Link to="/video/player" className="text-gray-400 hover:text-white transition-colors" title="Player">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
