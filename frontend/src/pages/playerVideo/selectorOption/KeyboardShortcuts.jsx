                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-4 pb-3 border-b border-white/10">
                            <h3 className="text-white font-bold text-lg">Raccourcis clavier</h3>
                            <button
                                onClick={() => setIsVisible(false)}
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                                <span className="text-white text-sm">Oui - Noter</span>
                            ...
                            <div className="flex items-center justify-between p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                                <span className="text-white text-sm">A discuter</span>
                                <kbd className="px-3 py-1.5 bg-white/10 border border-white/20 rounded text-white text-xs font-mono">
                                    →
                                </kbd>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-3 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                                <span className="text-white text-sm">Note rapide</span>
                        ...
                        <div className="mt-4 p-3 bg-white/5 rounded-lg">
                            <p className="text-xs text-gray-400 text-center">
                                Les raccourcis sont desactives dans les modals
                            </p>
                        </div>
                    </div>
                </div>
